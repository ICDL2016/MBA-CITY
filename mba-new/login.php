<?php require_once '_header.php'; ?>
  ...
  <div class="login container">
    <div class="login-img text-center">
      <img src="img/login/login-arrow.png" alt="arrow">
    </div>

    <div class="login-form text-center">
      <h3 class="login-title">Войти в учебный кабинет</h3>
      ...
      <form action="" class="login-form__form">
        ...
        <button class="login-btn p404-btn">Вход</button>
      </form>

      <img src="img/login/login-bd.png" alt="border" class="login-border">
    </div>
